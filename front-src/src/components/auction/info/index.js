    ...
    render(){
        return (
            <div className="auction-info__wrap">
                ...
                <h2>
                    <span className="auction-info__title">中国山水之精粹</span>
                    {!this.props.history
                ...
                <p className="auction-info__info">竞拍时间：{new Date().toLocaleDateString()}</p>
                <p className="auction-info__info">倒数： <span className="main-color">1天</span></p>

                <OverflowDrop
                    className="max-height2 auction-info__content"
                    content="国画为东方瑰宝，上承中国悠久文化史，下启百年底蕴传奇。近百年来， 国画之美,汇集了东方文化和西方美学的丰富内涵,孕育国画为东方瑰宝，上承中国悠久文化史，下启百年底蕴传奇。近百年来， 国画之美,汇集了东方文化和西方美学的丰富内涵,孕育"
                />
