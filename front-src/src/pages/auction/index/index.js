...
import Head from '../../../components/search_head/index'
import { getArtists } from '../../../helper/http/index'
        ...
        return (
            <div className="board-container">
                ...
                <div className="category">
                    <a href="/auction_schedule.html?classno=1" className="category-item">
                        <img src={require('../../../assets/images/auction/img_CN painting.png')} alt=""/>
                    </a>
                    <a href="/auction_schedule.html?classno=2" className="category-item">
                        <img src={require('../../../assets/images/auction/img_sculpture.png')} alt=""/>
                    </a>
                </div>
                <div className="category">
                    <a href="/auction_schedule.html?classno=3" className="category-item">
                        <img src={require('../../../assets/images/auction/img_porcelain.png')} alt=""/>
                    </a>
                    <a href="/auction_schedule.html?classno=4" className="category-item">
